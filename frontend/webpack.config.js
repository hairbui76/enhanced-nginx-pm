...
module.exports = {
	...
	resolve: {
		alias: {
			...
			"vector-map":
				"tabler-ui/dist/assets/js/vendors/jquery-jvectormap-2.0.3.min",
			"vector-map-de":
				"tabler-ui/dist/assets/js/vendors/jquery-jvectormap-de-merc",
			"vector-map-world":
				"tabler-ui/dist/assets/js/vendors/jquery-jvectormap-world-mill",
